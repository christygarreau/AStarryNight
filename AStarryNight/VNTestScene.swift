...
let VNTestSceneTitleX                   = "title label x"
let VNTestSceneTitleY                   = "title label y"
let VNTestSceneTitleLabelText           = "title label text"
let VNTestSceneTitleLabelFont           = "title label font"
let VNTestSceneTitleLabelSize           = "title label size"
let VNTestSceneTitleLabelColor          = "title label color"
...
class VNTestScene : SKScene
{
    ...
    func loadUI() {
        ...
        let dictionaryFilePath:String? = Bundle.main.path(forResource: "MainMenu", ofType: "plist")
        ...
        // Now grab the values for the Title Label
        let titleLabelX:CGFloat = CGFloat( (standardSettings.object(forKey: VNTestSceneTitleX) as! NSNumber).doubleValue )
        let titleLabelY:CGFloat = CGFloat( (standardSettings.object(forKey: VNTestSceneTitleY) as! NSNumber).doubleValue )
        let titleLabelFontSize:CGFloat = CGFloat( (standardSettings.object(forKey: VNTestSceneTitleLabelSize) as! NSNumber).doubleValue )
        let titleLabelText = standardSettings.object(forKey: VNTestSceneTitleLabelText) as! NSString
        let titleLabelFont = standardSettings.object(forKey: VNTestSceneTitleLabelFont) as! NSString
        let titleLabelColors = standardSettings.object(forKey: VNTestSceneTitleLabelColor) as! NSDictionary
        
        // Decode title colors
        let titleLabelColorR = (titleLabelColors.object(forKey: "r") as! NSNumber).intValue
        let titleLabelColorG = (titleLabelColors.object(forKey: "g") as! NSNumber).intValue
        let titleLabelColorB = (titleLabelColors.object(forKey: "b") as! NSNumber).intValue
        
        // Load the "A Starry Night" label
        loadLabel = DSMultilineLabelNode(fontNamed: titleLabelFont as String)
        loadLabel!.fontSize = titleLabelFontSize
        loadLabel!.text = titleLabelText as String
        loadLabel!.position = SMPositionWithNormalizedCoordinates(titleLabelX, normalizedY: titleLabelY);
        loadLabel!.color = SMColorFromRGB(titleLabelColorR, g: titleLabelColorG, b: titleLabelColorB);
        loadLabel!.zPosition = VNTestSceneZForLabels
        self.addChild(loadLabel!)
    ...
    func loadDefaultUI() -> NSDictionary
    {
        ...
        resourcesDict.setObject("Cupcakie", forKey: VNTestSceneStartNewGameFont as NSCopying)
        ...
        resourcesDict.setObject(0.2, forKey: VNTestSceneContinueLabelY as NSCopying)
        resourcesDict.setObject("Cupcakie", forKey: VNTestSceneContinueFont as NSCopying)
        ...
        //Create settings for "A Starry Night" label
        resourcesDict.setObject(0.5, forKey: VNTestSceneTitleX as NSCopying)
        resourcesDict.setObject(0.2, forKey: VNTestSceneTitleY as NSCopying)
        resourcesDict.setObject("Cupcakie", forKey: VNTestSceneTitleLabelFont as NSCopying)
        resourcesDict.setObject(200, forKey: VNTestSceneTitleLabelSize as NSCopying)
        resourcesDict.setObject(whiteColorDict.copy(), forKey: VNTestSceneTitleLabelColor as NSCopying)
        ...
        // Set up script data
        resourcesDict.setObject("Script", forKey: VNTestSceneScriptToLoad as NSCopying)
